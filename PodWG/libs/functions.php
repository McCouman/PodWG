...
* PodWG.de without overwritting your changes. Instead use the config.json file
* in the /data folder to customize your documentation.
*
* Want to add a new feature? Send me a pull request or open an issue - https://github.com/mccouman/PodWG.de
*
* Learn more about what you can customize here: http://PodWG.de
*/
...
function get_options() {
	...
	if ($options['theme'] !== 'custom') {
		...
		if (!in_array($options['theme'], array("blue","navy","green","red"))) {
			echo "<strong>PodWG.de Config Error:</strong><br>The theme you set is not not a valid option. Please use one of the following options: " . join(array_keys($themes), ', ') . ' or <a href="http://PodWG.de">learn more</a> about how to customize the colors.';
			exit;
		}
	} else {
		if (empty($options['colors'])) {
			echo '<strong>PodWG.de Config Error:</strong><br>You are trying to use a custom theme, but did not setup your color options in the config. <a href="http://PodWG.de">Learn more</a> about how to customize the colors.';
			exit;
		}
	}
...
function docs_url($tree, $branch = false) {
	...
	if ($branch['type'] === 'file') {
		...
		if ($branch) {
			...
			echo '<strong>PodWG.de Config Error:</strong><br>Unable to find the first page in the /data folder. Double check you have at least one file in the root of of the /data folder. Also make sure you do not have any empty folders. Visit the data to <a href="http://PodWG.de">learn more</a> about how the default routing works.';
			exit;
		}
	}
}
